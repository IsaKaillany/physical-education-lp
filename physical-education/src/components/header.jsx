...
export function Header() {
    return (
        <nav className="flex items-center justify-between gap-4 max-w-full text-white">
            <img src={titleLogo} className="" />
            <div className="flex gap-8 justify-center items-center bg-[#0C1221] w-[480px] h-16 rounded-full p-5">
